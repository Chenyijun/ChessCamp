class InstructorsController < ApplicationController
  ...
  private
    ...
    def instructor_params
      params.require(:instructor).permit(:first_name, :last_name, :bio, :email, :phone, :active, user_attributes: [:username, :password, :password_confirmation, :instructor_id, :role])
    end
end
